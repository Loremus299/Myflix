...
export default function Features() {
  return (
    <div
      className="min-h-screen grid portrait:flex-col gap-8 grid-cols-3 pt-4 place-items-center portrait:hidden"
      id="features"
    >
      <div className="grid gap-4">
        ...
        <FeatureCard>
          ...
          <p>
            Rate each and every movie in your library a personal score.
            (Upcoming feature)
          </p>
        </FeatureCard>
      </div>
      <div>
        <Image
          ...
          className="w-fit rounded-2xl border-2 border-black"
        ></Image>
      </div>
      <div className="grid gap-4">
        <FeatureCard>
        ...
        <FeatureCard>
          ...
          <p>
            Filter and browse through every single movie in your catalog with
            many options.
          </p>
        </FeatureCard>
        <FeatureCard>
          <h1 className="text-2xl mb-2">Open Source</h1>
          <p>
